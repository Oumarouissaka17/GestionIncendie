...
models = [DirectionProvinciale, Ccdrf, SecteurForestier, Incendie, PointEau, PosteVigie, TracheeParFeu]
fichiers = [dp_sh, ccdrf_shp, sf_shp, incendies_shp, points_eau_shp, postesVigies_shp, tpf_shp]
mappings = [dp_mapping, ccdrf_mapping, sf_mapping, incendies_mapping, point_eau_mapping, postesVigies_mapping, tpf_mapping]
